...
- 补体力：体力耗尽提醒和商店中均可主动观看激励视频，完整观看后增加 1 点体力，不设冷却和次数上限，也不计入商店道具每日视频额度；广告不可用或体力已满时入口隐藏或禁用。自然恢复改为每10分钟1点（上限5点）。
- 金币补体力：体力耗尽提醒和商店均可用 1000 金币购买 1 点体力，体力已满或金币不足时不可购买。
